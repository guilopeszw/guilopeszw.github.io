    ...
    <Section id="about">
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "64px", alignItems: "start" }}
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          {[
            `cs student at federal university of paraíba (ufpb). i build backend systems and machine learning pipelines — mostly around audio.`,
            `at aria, i design data infrastructure — schemas, microservices, pipelines and apis. at moises.ai, i worked on audio analysis systems for chord recognition.`,
            `i also did machine learning research with the university of pennsylvania, evaluating deep learning models for medical imaging classification.`,
            `through tail, i build ai-driven haptic systems that turn sound into touch, making music accessible to hearing-impaired people.`,
